...
from dealer_purchase.models import Manufacturer, Car, City

MANUFACTURER_LIST = reverse("dealer_purchase:manufacturer-list")
CARS_LIST = reverse("dealer_purchase:car-list")
DRIVERS_LIST = reverse("dealer_purchase:driver-list")
